...
class ExMediaPickerLikeWechat extends StatefulWidget {
  ...
  @override
  State<ExMediaPickerLikeWechat> createState() =>
      _ExMediaPickerLikeWechatState();
}
            ...
            title: SizedBox(
              ...
              child: const Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      "Example of Video Image Picker like wechat",
                      maxLines: 1,
                ...
                child: TextButton(
                    onPressed: () {
                      showMenu(
                        ...
                        position:
                            const RelativeRect.fromLTRB(170, 180, 110, 10),
                        items: [
                          ///建议指定value属性
                  ...
                  return Container(
                    ...
                    child: ListView(
                      ...
                      children: List.generate(
                        assetEntityList!.length,
                        (index) => Padding(
                          ///主要用来控制图片之间边距
                          padding: const EdgeInsets.only(left: 8.0, right: 8.0),
                          child: Image(
                            image: AssetEntityImageProvider(
                                assetEntityList![index],
                                isOriginal: false),
                            width: 40,
                            height: 40,
                          ),
