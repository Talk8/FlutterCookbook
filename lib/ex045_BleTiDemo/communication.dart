...
import 'oad_screen.dart';
import 'log_util.dart';

///数据交互页面,界面比较简单：使用button排列实现各种功能。demo中的所有功能都在这个界面中,有些数据
///转换的util方法可以参考SDK中的代码。
...
class _CommPageState extends State<CommPage> with BleCallback2 {
  ...
  void onDataReceived(String deviceId, String serviceUuid,
    ...
    print(' ori uuid: ${serviceUuid.toString()} - char: ${characteristicUuid.toString()}');
    print(' ori data: ${data.toString()}');
